...
END_DATE = "2024-01-02 00:00:00" # Set an end date for a batch run
...
if __name__ == "__main__":
    ...
    # This loop processes data in a fixed time range, then stops.
    # To process continuously, use the original script's logic.
